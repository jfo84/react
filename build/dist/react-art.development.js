...
function updateFundamentalComponent$1(current, workInProgress, renderExpirationTime) {
    ...
    case FundamentalComponent:
      {
        if (enableFundamentalAPI) {
          return updateFundamentalComponent$1(current, workInProgress, renderExpirationTime);
        }
    ...
    case ScopeComponent:
      {
        if (enableScopeAPI) {
          ...
          if (enableFlareAPI) {
            ...
            var _oldProps = current !== null ? current.memoizedProps : _newProps;
...
if (true && replayFailedUnitOfWorkWithInvokeGuardedCallback) {
  ...
  beginWork$$1 = function (current, unitOfWork, expirationTime) {
    ...
    try {
      return beginWork$1(current, unitOfWork, expirationTime);
    } catch (originalError) {
      ...
      invokeGuardedCallback(null, beginWork$1, null, current, unitOfWork, expirationTime);
...
function checkForWrongSuspensePriorityInDEV(sourceFiber) {
  {
    ...
    if ((sourceFiber.mode & ConcurrentMode) !== NoEffect && (currentPriorityLevel === UserBlockingPriority || currentPriorityLevel === ImmediatePriority)) {
      ...
      while (workInProgressNode !== null) {
        ...
        var current = workInProgressNode.alternate;
