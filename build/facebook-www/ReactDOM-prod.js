...
function assertIsMounted(fiber) {
  if (getNearestMountedFiber(fiber) !== fiber) throw ReactErrorProd(Error(188));
}
function findCurrentFiberUsingSlowPath(fiber) {
  var alternate = fiber.alternate;
  if (!alternate) {
    alternate = getNearestMountedFiber(fiber);
    if (null === alternate) throw ReactErrorProd(Error(188));
...
function validateResponderContext() {
  if (null === currentInstance) throw ReactErrorProd(Error(346));
}
...
function collectScopedNodesFromChildren(
  ...
  for (; null !== startingChild; ) {
    ...
    5 === node.tag &&
      !0 === fn(node.type, node.memoizedProps) &&
...
function collectFirstScopedNodeFromChildren(startingChild, fn$jscomp$0) {
  for (; null !== startingChild; ) {
    ...
    if (
      5 === scopedNode.tag &&
      !0 === fn(scopedNode.type, scopedNode.memoizedProps)
    )
      scopedNode = scopedNode.stateNode;
    else {
      var child = scopedNode.child;
      13 === scopedNode.tag &&
        null !== scopedNode.memoizedState &&
        (child = scopedNode.child.sibling.child);
      scopedNode =
        null !== child ? collectFirstScopedNodeFromChildren(child, fn) : null;
    }
  ...
  switch (finishedWork.tag) {
    ...
    case 5:
      ...
      if (null != instance) {
        ...
        current$$1.listeners !== instance &&
          updateEventListeners(instance, finishedWork, null);
      }
      break;
    case 6:
    ...
    case 21:
      ...
      newProps = instance.listeners;
      (null !== current$$1 ? current$$1.memoizedProps : instance).listeners !==
        newProps && updateEventListeners(newProps, finishedWork, null);
      break;
    default:
      throw ReactErrorProd(Error(163));
  }
      ...
      if (null !== workInProgress)
        ...
        switch (
          ...
          case RootFatalErrored:
            throw ReactErrorProd(Error(345));
          case RootErrored:
            if (2 !== expirationTime) {
              markRootExpiredAtTime(root, 2);
              break;
            }
            commitRoot(root);
            break;
  ...
  if (root.finishedExpirationTime === lastExpiredTime) commitRoot(root);
    ...
    if (null !== workInProgress) {
      ...
      if (workInProgressRootExitStatus === RootFatalErrored)
        ...
        ensureRootIsScheduled(root),
        prevExecutionContext);
      if (null !== workInProgress) throw ReactErrorProd(Error(261));
      stopWorkLoopTimer(interruptedBy, !0);
      interruptedBy = null;
    ...
    if (0 === (workInProgress.effectTag & 2048)) {
      a: {
        var JSCompiler_inline_result,
          ...
          current = current$$1,
          workInProgress$jscomp$0 = workInProgress,
          renderExpirationTime$jscomp$0 = renderExpirationTime,
          newProps = workInProgress$jscomp$0.pendingProps;
        switch (workInProgress$jscomp$0.tag) {
          ...
          case 0:
            break;
          case 1:
            isContextProvider(workInProgress$jscomp$0.type) &&
              popContext(workInProgress$jscomp$0);
            break;
          case 3:
            ...
            (null === current || null === current.child) &&
              popHydrationState(workInProgress$jscomp$0) &&
              markUpdate(workInProgress$jscomp$0);
            updateHostContainer(workInProgress$jscomp$0);
            break;
          case 5:
            ...
            var rootContainerInstance = requiredContext(
              ...
              type = workInProgress$jscomp$0.type;
            if (null !== current && null != workInProgress$jscomp$0.stateNode)
              updateHostComponent$1(
                current,
                ...
                current.memoizedProps.listeners !== newProps.listeners &&
                  markUpdate(workInProgress$jscomp$0),
                current.ref !== workInProgress$jscomp$0.ref &&
                  (workInProgress$jscomp$0.effectTag |= 128);
            else if (newProps) {
              var currentHostContext = requiredContext(
                contextStackCursor$1.current
              );
              console.log("workInProgress: ", workInProgress$jscomp$0);
              if (popHydrationState(workInProgress$jscomp$0)) {
                var fiber = workInProgress$jscomp$0,
                  instance = fiber.stateNode,
                  type$jscomp$0 = fiber.type,
                ...
                var propKey = void 0,
                  ...
                  tag = type$jscomp$0,
                  rawProps = props,
                  rootContainerElement = rootContainerInstance$jscomp$0;
                switch (tag) {
                  case "iframe":
                  case "object":
                  case "embed":
                ...
                fiber.updateQueue = updatePayload$jscomp$0;
                var JSCompiler_inline_result$jscomp$1 =
                  null !== updatePayload$jscomp$0 ? !0 : !1;
                ...
                var internalInstanceHandle = workInProgress$jscomp$0,
                  type$jscomp$1 = type,
                  ...
                  namespaceURI = currentHostContext;
                namespaceURI === Namespaces.html &&
                  (namespaceURI = getIntrinsicNamespace(type$jscomp$1));
                if (namespaceURI === Namespaces.html)
                  if ("script" === type$jscomp$1) {
                    var div = ownerDocument.createElement("div");
                    div.innerHTML = "<script>\x3c/script>";
                    var domElement$jscomp$0 = div.removeChild(div.firstChild);
                  } else if ("string" === typeof props$jscomp$0.is)
                    domElement$jscomp$0 = ownerDocument.createElement(
                      type$jscomp$1,
                      { is: props$jscomp$0.is }
                    );
                  else {
                    if (
                      ((domElement$jscomp$0 = ownerDocument.createElement(
                      ...
                      "select" === type$jscomp$1)
                    ) {
                      var node = domElement$jscomp$0;
                      props$jscomp$0.multiple
                        ? (node.multiple = !0)
                        : props$jscomp$0.size &&
                          (node.size = props$jscomp$0.size);
                    }
                  }
                else
                  domElement$jscomp$0 = ownerDocument.createElementNS(
                    namespaceURI,
                    type$jscomp$1
                  );
                var domElement$jscomp$1 = domElement$jscomp$0;
                domElement$jscomp$1[
                  internalInstanceKey
                ] = internalInstanceHandle;
                domElement$jscomp$1[internalEventHandlersKey] = newProps;
                appendAllChildren(
                  domElement$jscomp$1,
                  workInProgress$jscomp$0,
                  !1,
                ...
                workInProgress$jscomp$0.stateNode = domElement$jscomp$1;
                ...
                var domElement$jscomp$2 = domElement$jscomp$1,
                  tag$jscomp$0 = type,
                  rawProps$jscomp$0 = newProps,
                  rootContainerElement$jscomp$0 = rootContainerInstance,
                ...
                switch (tag$jscomp$0) {
                  ...
                  case "object":
                  case "embed":
                    trapBubbledEvent("load", domElement$jscomp$2);
                    var props$jscomp$1 = rawProps$jscomp$0;
                    break;
                  case "video":
                  case "audio":
                    for (
                      var i$jscomp$0 = 0;
                      i$jscomp$0 < mediaEventTypes.length;
                      i$jscomp$0++
                    )
                      trapBubbledEvent(
                        mediaEventTypes[i$jscomp$0],
                        domElement$jscomp$2
                      );
                    props$jscomp$1 = rawProps$jscomp$0;
                    break;
                  case "source":
                    trapBubbledEvent("error", domElement$jscomp$2);
                    props$jscomp$1 = rawProps$jscomp$0;
                    break;
                  case "img":
                  case "image":
                  case "link":
                    ...
                    break;
                  case "form":
                    trapBubbledEvent("reset", domElement$jscomp$2);
                    trapBubbledEvent("submit", domElement$jscomp$2);
                    props$jscomp$1 = rawProps$jscomp$0;
                    break;
                  case "details":
                    trapBubbledEvent("toggle", domElement$jscomp$2);
                    props$jscomp$1 = rawProps$jscomp$0;
                    break;
                  case "input":
                    initWrapperState(domElement$jscomp$2, rawProps$jscomp$0);
                    props$jscomp$1 = getHostProps(
                      domElement$jscomp$2,
                      rawProps$jscomp$0
                    );
                    trapBubbledEvent("invalid", domElement$jscomp$2);
                    ensureListeningTo(
                      rootContainerElement$jscomp$0,
                      "onChange"
                    );
                    break;
                  case "option":
                    props$jscomp$1 = getHostProps$1(
                      domElement$jscomp$2,
                      rawProps$jscomp$0
                    );
                    break;
                  case "select":
                    domElement$jscomp$2._wrapperState = {
                      wasMultiple: !!rawProps$jscomp$0.multiple
                    };
                    props$jscomp$1 = Object.assign({}, rawProps$jscomp$0, {
                      value: void 0
                    });
                    trapBubbledEvent("invalid", domElement$jscomp$2);
                    ensureListeningTo(
                    ...
                    break;
                  case "textarea":
                    initWrapperState$2(domElement$jscomp$2, rawProps$jscomp$0);
                    props$jscomp$1 = getHostProps$3(
                      domElement$jscomp$2,
                      rawProps$jscomp$0
                    );
                    trapBubbledEvent("invalid", domElement$jscomp$2);
                ...
                assertValidProps(tag$jscomp$0, props$jscomp$1);
                var propKey$jscomp$0 = void 0,
                  tag$jscomp$1 = tag$jscomp$0,
                  domElement$jscomp$3 = domElement$jscomp$2,
                  rootContainerElement$jscomp$1 = rootContainerElement$jscomp$0,
                  nextProps = props$jscomp$1,
                  isCustomComponentTag$jscomp$0 = isCustomComponentTag;
                for (propKey$jscomp$0 in nextProps)
                  if (nextProps.hasOwnProperty(propKey$jscomp$0)) {
                    ...
                    if ("style" === propKey$jscomp$0)
                      setValueForStyles(domElement$jscomp$3, nextProp$jscomp$0);
                    else if ("dangerouslySetInnerHTML" === propKey$jscomp$0) {
                      var nextHtml = nextProp$jscomp$0
                        ? nextProp$jscomp$0.__html
                        : void 0;
                      null != nextHtml &&
                        setInnerHTML(domElement$jscomp$3, nextHtml);
                    } else
                      "children" === propKey$jscomp$0
                        ? "string" === typeof nextProp$jscomp$0
                          ? ("textarea" !== tag$jscomp$1 ||
                              "" !== nextProp$jscomp$0) &&
                            setTextContent(
                              domElement$jscomp$3,
                              nextProp$jscomp$0
                        ...
                        : "listeners" !== propKey$jscomp$0 &&
                          "suppressContentEditableWarning" !==
                            propKey$jscomp$0 &&
                          "suppressHydrationWarning" !== propKey$jscomp$0 &&
                          "autoFocus" !== propKey$jscomp$0 &&
                          (registrationNameModules.hasOwnProperty(
                            propKey$jscomp$0
                          )
                            ? null != nextProp$jscomp$0 &&
                              ensureListeningTo(
                                rootContainerElement$jscomp$1,
                                propKey$jscomp$0
                              )
                            : null != nextProp$jscomp$0 &&
                              setValueForProperty(
                                ...
                                propKey$jscomp$0,
                                nextProp$jscomp$0,
                                isCustomComponentTag$jscomp$0
                              ));
                  }
                switch (tag$jscomp$0) {
                  case "input":
                    track(domElement$jscomp$2);
                    postMountWrapper(
                      domElement$jscomp$2,
                      rawProps$jscomp$0,
                      !1
                  ...
                  case "textarea":
                    track(domElement$jscomp$2);
                    postMountWrapper$3(domElement$jscomp$2, rawProps$jscomp$0);
                    break;
                  case "option":
                    null != rawProps$jscomp$0.value &&
                      domElement$jscomp$2.setAttribute(
                        "value",
                        "" + getToStringValue(rawProps$jscomp$0.value)
                      );
                    break;
                  case "select":
                    var element = domElement$jscomp$2,
                      props$jscomp$2 = rawProps$jscomp$0;
                    element.multiple = !!props$jscomp$2.multiple;
                    var value = props$jscomp$2.value;
                    null != value
                      ? updateOptions(
                          element,
                          !!props$jscomp$2.multiple,
                          value,
                          !1
                        )
                      : null != props$jscomp$2.defaultValue &&
                        updateOptions(
                          element,
                          !!props$jscomp$2.multiple,
                    ...
                    break;
                  default:
                    "function" === typeof props$jscomp$1.onClick &&
                      (domElement$jscomp$2.onclick = noop);
                }
                (JSCompiler_inline_result$jscomp$0 = shouldAutoFocusHostComponent(
                  type,
                  newProps
                )) && markUpdate(workInProgress$jscomp$0);
              }
              null !== workInProgress$jscomp$0.ref &&
                (workInProgress$jscomp$0.effectTag |= 128);
            } else if (null === workInProgress$jscomp$0.stateNode)
              throw ReactErrorProd(Error(166));
            break;
          case 6:
            if (current && null != workInProgress$jscomp$0.stateNode)
              updateHostText$1(
                current,
                workInProgress$jscomp$0,
              ...
              if (
                ...
                null === workInProgress$jscomp$0.stateNode
              )
                throw ReactErrorProd(Error(166));
              ...
              requiredContext(contextStackCursor$1.current);
              if (popHydrationState(workInProgress$jscomp$0)) {
                var fiber$jscomp$0 = workInProgress$jscomp$0,
                  textInstance = fiber$jscomp$0.stateNode,
                  text = fiber$jscomp$0.memoizedProps;
                textInstance[internalInstanceKey] = fiber$jscomp$0;
                (JSCompiler_inline_result = textInstance.nodeValue !== text) &&
                  markUpdate(workInProgress$jscomp$0);
              } else {
                var internalInstanceHandle$jscomp$0 = workInProgress$jscomp$0;
                var textNode = (9 === _rootContainerInstance.nodeType
                  ? _rootContainerInstance
                  : _rootContainerInstance.ownerDocument
                ).createTextNode(newProps);
                textNode[internalInstanceKey] = internalInstanceHandle$jscomp$0;
          ...
          case 13:
            ...
            if (null !== nextState && null !== nextState.dehydrated) {
              if (null === current) {
                if (!popHydrationState(workInProgress$jscomp$0))
                  throw ReactErrorProd(Error(318));
                var fiber$jscomp$1 = workInProgress$jscomp$0,
                  suspenseState = fiber$jscomp$1.memoizedState,
                  suspenseInstance =
                    null !== suspenseState ? suspenseState.dehydrated : null;
                if (!suspenseInstance) throw ReactErrorProd(Error(317));
                suspenseInstance[internalInstanceKey] = fiber$jscomp$1;
              } else
                resetHydrationState(),
                  0 === (workInProgress$jscomp$0.effectTag & 64) &&
                    (workInProgress$jscomp$0.memoizedState = null),
                  (workInProgress$jscomp$0.effectTag |= 4);
              break;
            }
            if (0 !== (workInProgress$jscomp$0.effectTag & 64)) {
              workInProgress$jscomp$0.expirationTime = renderExpirationTime$jscomp$0;
              var next = workInProgress$jscomp$0;
              break a;
            }
            var nextDidTimeout = null !== nextState,
              prevDidTimeout = !1;
            if (null === current) popHydrationState(workInProgress$jscomp$0);
            else {
              var prevState = current.memoizedState;
              prevDidTimeout = null !== prevState;
              if (!nextDidTimeout && null !== prevState) {
                var currentFallbackChild = current.child.sibling;
                if (null !== currentFallbackChild) {
                  var first = workInProgress$jscomp$0.firstEffect;
                  null !== first
                    ? ((workInProgress$jscomp$0.firstEffect = currentFallbackChild),
                      (currentFallbackChild.nextEffect = first))
                    : ((workInProgress$jscomp$0.firstEffect = workInProgress$jscomp$0.lastEffect = currentFallbackChild),
            ...
            nextDidTimeout &&
              !prevDidTimeout &&
              0 !== (workInProgress$jscomp$0.mode & 2) &&
              ((null === current &&
                !0 !==
                  workInProgress$jscomp$0.memoizedProps
            ...
            if (nextDidTimeout || prevDidTimeout)
              workInProgress$jscomp$0.effectTag |= 4;
            null !== workInProgress$jscomp$0.updateQueue &&
              null != workInProgress$jscomp$0.memoizedProps.suspenseCallback &&
              (workInProgress$jscomp$0.effectTag |= 4);
            break;
          case 7:
            break;
          ...
          case 4:
            ...
            break;
          case 10:
            popProvider(workInProgress$jscomp$0);
            break;
          case 9:
            break;
          case 14:
          ...
          case 19:
            ...
            if (null === renderedTail)
              if (didSuspendAlready) cutOffTailIfNeeded(renderState, !1);
                ...
                if (
                  ...
                  for (
                    var row = workInProgress$jscomp$0.child;
                    null !== row;

                  ) {
                    var suspended = findFirstSuspended(row);
                    if (null !== suspended) {
                      workInProgress$jscomp$0.effectTag |= 64;
                      cutOffTailIfNeeded(renderState, !1);
                      var newThennables = suspended.updateQueue;
                      null !== newThennables &&
                        ((workInProgress$jscomp$0.updateQueue = newThennables),
                        (workInProgress$jscomp$0.effectTag |= 4));
                      workInProgress$jscomp$0.firstEffect = workInProgress$jscomp$0.lastEffect = null;
                      for (
                        var renderExpirationTime$jscomp$1 = renderExpirationTime$jscomp$0,
                          child = workInProgress$jscomp$0.child;
                        null !== child;

                      ) {
                        var workInProgress$jscomp$1 = child,
                          renderExpirationTime$jscomp$2 = renderExpirationTime$jscomp$1;
                        workInProgress$jscomp$1.effectTag &= 2;
                        workInProgress$jscomp$1.nextEffect = null;
                        workInProgress$jscomp$1.firstEffect = null;
                        workInProgress$jscomp$1.lastEffect = null;
                        var current$jscomp$0 =
                          workInProgress$jscomp$1.alternate;
                        if (null === current$jscomp$0)
                          (workInProgress$jscomp$1.childExpirationTime = 0),
                            (workInProgress$jscomp$1.expirationTime = renderExpirationTime$jscomp$2),
                            (workInProgress$jscomp$1.child = null),
                            (workInProgress$jscomp$1.memoizedProps = null),
                            (workInProgress$jscomp$1.memoizedState = null),
                            (workInProgress$jscomp$1.updateQueue = null),
                            (workInProgress$jscomp$1.dependencies = null);
                        else {
                          workInProgress$jscomp$1.childExpirationTime =
                            current$jscomp$0.childExpirationTime;
                          workInProgress$jscomp$1.expirationTime =
                            current$jscomp$0.expirationTime;
                          workInProgress$jscomp$1.child =
                            current$jscomp$0.child;
                          workInProgress$jscomp$1.memoizedProps =
                            current$jscomp$0.memoizedProps;
                          workInProgress$jscomp$1.memoizedState =
                            current$jscomp$0.memoizedState;
                          workInProgress$jscomp$1.updateQueue =
                            current$jscomp$0.updateQueue;
                          var currentDependencies =
                            current$jscomp$0.dependencies;
                          workInProgress$jscomp$1.dependencies =
                            null === currentDependencies
                              ? null
                              : {
                                  expirationTime:
                                    currentDependencies.expirationTime,
                                  firstContext:
                      ...
                      next = workInProgress$jscomp$0.child;
                      break a;
                    }
                    row = row.sibling;
                  }
              ...
              if (!didSuspendAlready) {
                ...
                if (null !== _suspended) {
                  if (
                    ...
                    null !== _newThennables &&
                      ((workInProgress$jscomp$0.updateQueue = _newThennables),
                      (workInProgress$jscomp$0.effectTag |= 4));
                    var lastEffect = (workInProgress$jscomp$0.lastEffect =
                  ...
                  now() > renderState.tailExpiration &&
                    ...
                    (didSuspendAlready = !0),
                    cutOffTailIfNeeded(renderState, !1),
                    (workInProgress$jscomp$0.expirationTime = workInProgress$jscomp$0.childExpirationTime =
                      renderExpirationTime$jscomp$0 - 1));
              }
              if (renderState.isBackwards)
                (renderedTail.sibling = workInProgress$jscomp$0.child),
                  (workInProgress$jscomp$0.child = renderedTail);
              else {
            ...
            if (null !== renderState.tail) {
              0 === renderState.tailExpiration &&
                (renderState.tailExpiration = now() + 500);
              var next$jscomp$0 = renderState.tail;
              renderState.rendering = next$jscomp$0;
              renderState.tail = next$jscomp$0.sibling;
              renderState.lastEffect = workInProgress$jscomp$0.lastEffect;
              next$jscomp$0.sibling = null;
          ...
          case 21:
            if (null === current) {
              var _type3 = workInProgress$jscomp$0.type,
                scopeInstance = {
                  fiber: workInProgress$jscomp$0,
                  methods: null
                };
              workInProgress$jscomp$0.stateNode = scopeInstance;
              scopeInstance.methods = createScopeMethods(_type3, scopeInstance);
              var _listeners2 = newProps.listeners;
              if (null != _listeners2) {
                var _rootContainerInstance2 = requiredContext(
                  rootInstanceStackCursor.current
                );
                updateEventListeners(
                  _listeners2,
            ...
            break;
          default:
            throw ReactErrorProd(Error(156), workInProgress$jscomp$0.tag);
        }
        next = null;
      }
      ...
      if (null !== _next) {
        var fiber$jscomp$2 = workInProgress;
        enableUserTimingAPI &&
          supportsUserTiming &&
          !shouldIgnoreFiber(fiber$jscomp$2) &&
          ((currentFiber = fiber$jscomp$2.return),
          fiber$jscomp$2._debugIsCurrentlyTiming &&
            ((fiber$jscomp$2._debugIsCurrentlyTiming = !1),
            endFiberMark(
              fiber$jscomp$2,
              null,
              13 === fiber$jscomp$2.tag
                ? "Rendering was suspended"
                : "An error was thrown inside this error boundary"
            )));
        _next.effectTag &= 2047;
        return _next;
      }
      stopWorkTimer(workInProgress);
      null !== returnFiber &&
        ((returnFiber.firstEffect = returnFiber.lastEffect = null),
        (returnFiber.effectTag |= 2048));
    }
...
beginWork$$1 = function(current$$1, workInProgress, renderExpirationTime) {
  ...
  throw ReactErrorProd(Error(156), workInProgress.tag);
};
  ...
  switch (fiber.tag) {
    ...
    case 13:
      flushSync(function() {
        ...
        (root = computeExpirationBucket(requestCurrentTime(), 150, 100)),
        markRetryTimeIfNotHydrated(fiber, root);
  }
};
attemptUserBlockingHydration = function(fiber) {
  if (13 === fiber.tag) {
    var expTime = computeExpirationBucket(requestCurrentTime(), 150, 100);
...
ReactRoot.prototype.render = ReactSyncRoot.prototype.render = function(
  ...
  updateContainer(children, root, null, void 0 === callback ? null : callback);
};
ReactRoot.prototype.unmount = ReactSyncRoot.prototype.unmount = function(
  callback
) {
  var root = this._internalRoot;
  updateContainer(null, root, null, void 0 === callback ? null : callback);
};
...
var ReactDOM$1 = {
  ...
  unstable_scheduleHydration: function(target) {
