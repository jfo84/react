...
function processContext(type, context, threadID, isClass) {
  if (
    ...
    return validateContextBounds(isClass, threadID), isClass[threadID];
          ...
          a: {
            ...
            if (null === JSCompiler_inline_result)
              ...
              for (
                ...
                if (!is$1(deps[i], JSCompiler_inline_result[i])) {
                  JSCompiler_inline_result = !1;
                  break a;
                }
...
var ReactDOMServerRenderer = (function() {
      ...
      if ("object" === typeof elementType && null !== elementType)
        switch (elementType.$$typeof) {
          ...
          case REACT_SCOPE_TYPE:
            ...
            return "";
            throw ReactErrorProd(Error(343));
        }
      throw ReactErrorProd(
        Error(130),
    ...
    _proto.renderDOM = function(element, context, parentNamespace) {
      ...
      for (out in initialValue)
        if (hasOwnProperty.call(initialValue, out) && "listeners" !== out) {
