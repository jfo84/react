    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode)
        ...
        if (popHydrationState(workInProgress)) {
          ...
          propKey = newProps.listeners;
          null != propKey &&
            updateEventListeners(propKey, workInProgress, renderExpirationTime);
    ...
    case 13:
      ...
      if (null !== newProps && null !== newProps.dehydrated) {
        if (null === current) {
          ...
          if (!newProps) throw ReactErrorProd(Error(317));
          newProps[internalInstanceKey] = workInProgress;
          markSpawnedWork(1);
        } else
          resetHydrationState(),
...
function flushPassiveEffectsImpl() {
  ...
  for (
    ...
    try {
      ...
      if (null === effect) throw ReactErrorProd(Error(330));
