    ...
    if (null !== workInProgress) {
      ...
      if (null === workInProgress)
        switch (
          ...
          case RootErrored:
            if (2 !== lastExpiredTime) {
              lastExpiredTime = root.lastExpiredTime;
              if (0 === lastExpiredTime || 2 < lastExpiredTime)
                root.lastExpiredTime = 2;
              break;
            }
            commitRoot(root);
            break;
      ...
      a: {
        ...
        switch (current$$1.tag) {
          ...
          case 5:
            ...
            if (null !== instance$jscomp$0 && null != current$$1.stateNode)
              updateHostComponent$1(
                ...
                instance$jscomp$0.memoizedProps.listeners !==
                  newProps.listeners && markUpdate(current$$1),
                instance$jscomp$0.ref !== current$$1.ref &&
                  (current$$1.effectTag |= 128);
            else if (newProps) {
              requiredContext(contextStackCursor$1.current);
              console.log("workInProgress: ", current$$1);
              switch (type) {
              ...
              instance$jscomp$0 = newProps.listeners;
          ...
          case 13:
            ...
            if (null !== newProps && null !== newProps.dehydrated) {
              if (null === instance$jscomp$0) {
                ...
                throw ReactErrorProd(Error(344));
              }
          ...
          case 21:
            ...
            break;
          default:
            throw ReactErrorProd(Error(156), current$$1.tag);
        }
        current$$1 = null;
      }
...
function commitRootImpl(root$jscomp$0, renderPriorityLevel$jscomp$0) {
  ...
  if (finishedWork === root$jscomp$0.current) throw ReactErrorProd(Error(177));
