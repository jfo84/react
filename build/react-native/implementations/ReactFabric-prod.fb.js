  ...
  do {
    ...
    if (0 === (workInProgress.effectTag & 2048)) {
        ...
        switch (current$$1.tag) {
          ...
          case 5:
            ...
            if (null !== instance && null != current$$1.stateNode)
              ...
              renderExpirationTime$jscomp$0 = createNode(
                tag,
              ...
              instance = {
                node: renderExpirationTime$jscomp$0,
                canonical: instance
              };
          ...
          case 13:
            ...
            null !== instance &&
              ((tag = instance.memoizedState),
              (renderExpirationTime$jscomp$0 = null !== tag),
              newProps ||
                null === tag ||
                ((tag = instance.child.sibling),
                null !== tag &&
                  ((type = current$$1.firstEffect),
                  null !== type
                    ? ((current$$1.firstEffect = tag), (tag.nextEffect = type))
                    : ((current$$1.firstEffect = current$$1.lastEffect = tag),
                      (tag.nextEffect = null)),
                  (tag.effectTag = 8))));
            if (
              newProps &&
          ...
          case 19:
            ...
            tag = 0 !== (current$$1.effectTag & 64);
            type = newProps.rendering;
            if (null === type)
              if (tag) cutOffTailIfNeeded(newProps, !1);
              else {
                if (
                  workInProgressRootExitStatus !== RootIncomplete ||
                    ...
                    if (null !== type) {
                      ...
                      for (newProps = current$$1.child; null !== newProps; )
                        (renderExpirationTime$jscomp$0 = newProps),
                          ...
                          (type = renderExpirationTime$jscomp$0.alternate),
                          null === type
                            ? ((renderExpirationTime$jscomp$0.childExpirationTime = 0),
                              (renderExpirationTime$jscomp$0.expirationTime = tag),
            ...
            if (null !== newProps.tail) {
              ...
              newProps = tag ? (newProps & 1) | 2 : newProps & 1;
      ...
      if (1 === renderExpirationTime || 1 !== instance.childExpirationTime) {
        newProps = 0;
        for (
          renderExpirationTime$jscomp$0 = instance.child;
          null !== renderExpirationTime$jscomp$0;

        )
          (tag = renderExpirationTime$jscomp$0.expirationTime),
            (type = renderExpirationTime$jscomp$0.childExpirationTime),
            tag > newProps && (newProps = tag),
